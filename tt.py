...
with col1:
    st.image('kakao.jpg', width=200)
with col2:
    st.write('이름 : 조윤찬')
    '영문 : Jo Yun-Chan'
    '전화번호📞 : 010-6627-7595'
    'email✉️ : chan000204@naver.com'
    '주소🏠 : 충남 논산시 대학로 121'
''
''
'-------------------------------------------------------------------------------------------------------------------------'
...
with col1:
    st.write('1️⃣저는 꾸준히 :red[도전]하는 것을 좋아하는 사람입니다.')
with col2:
    st.write('2️⃣저는 다른 사람의 :red[이야기]를 들어줄 수 있는 사람입니다.')
with col3:
    st.write('3️⃣저는 다른 사람의 시간을 :red[소중히] 대하는 사람입니다.')
'--------------------------------------------------------------------------------------------------------------------------'
...
with col1:
    ...
    st.image('car2.jpg', width=300)
with col2:
    '#### 저는 제 미래가 저만의 미래라고 생각하지 않습니다. 앞으로 만날 사람들, 현재의 인연들, 과거의 사람들과 같이 만들어갈 미래라고 생각합니다. 그렇기 때문에 저는 제 현재를 하찮게 생각하지 않으며, 항상 감사하게 생각합니다. 소중한 현재를 위해, 찬란한 미래를 위해, 저는 더 빛나는 내일을 위해 노력할 것입니다.'
